    ...
    public class MainClass {
        ...
        public static void Main(string[] args) {
            if (args.Length < 3 || args.Length > 4) {
                ...
                Console.WriteLine("Usage: Main 1 <fake_source_ip> <timeout_millis> <erroneous_ip>");
                Console.WriteLine("Usage: Main 2 <timeout_millis> <erroneous_ip>");
                Console.WriteLine("- Mode 1: send fake answer to a host that queries this machine.");
                Console.WriteLine("- Mode 2: send fake answer to the first sniffed query (not implemented).");
